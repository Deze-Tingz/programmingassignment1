...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Handles user input for students
        userInput.inputStudentInfo(scnr);

        // displays student information
        userInput.displayStudentInfo();
        
        // Allows the user to input the keyword "DONE" after entering student information once they are ready
        userInput.inputStudentInfoWhileLoop();
