...
public class ProgramCommandHandling {
    ...
    public void inputUserCommand() {
        ...
        // Check if the command starts with "letter " and ends with the currentPid
//        if (this.userCommand.equals("letter " + currentPid)) {
//            printLetterGradeByPid(currentPid);
//        }
//        // Check if the command starts with "name " and ends with the currentPid
//        if (this.userCommand.equals("name " + currentPid)) {
//            // Method to find and print the full name of the student with the given PID
//            printNameByPid(currentPid);
//        }
       // else {
            switch (userCommand) {
                case "min score":
    ...
    private void getMinGrade() {
        ...
        for (Student student : students) {
            // If the current student's score is less than the minScore, update minScore
    ...
    private void getMaxGrade() {
        ...
        int minScore = students.getFirst().getGrade().getScore();
        for (Student student : students) {
            // If the current student's score is more than the maxScore, update maxScore
            if (student.getGrade().getScore() > minScore) {
